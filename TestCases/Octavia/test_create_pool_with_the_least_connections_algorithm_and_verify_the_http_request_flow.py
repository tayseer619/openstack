...
class test_create_pool_with_the_least_connections_algorithm_and_verify_the_http_request_flow(BaseTestCase):
    """A Test case for create_pool_with_the_least_connections_algorithm_and_verify_the_http_request_flow"""
    name = "create_pool_with_the_least_connections_algorithm_and_verify_the_http_request_flow"
    ...
    def run_test(self, testbed_obj):
        ...
        self.loadbalancer = utils.create_lb(
            overcloud_ep, overcloud_token, "HTTPS", 80, "LEAST_CONNECTIONS")
