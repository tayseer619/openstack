...
class test_verify_compute_nodes_are_able_communicate_with_eachother_on_lower_mtu_sizes(BaseTestCase):
    """test_verify_compute_nodes_are_able_communicate_with_eachother_on_lower_mtu_sizes"""
    name = "test_verify_compute_nodes_are_able_communicate_with_eachother_on_lower_mtu_sizes"
