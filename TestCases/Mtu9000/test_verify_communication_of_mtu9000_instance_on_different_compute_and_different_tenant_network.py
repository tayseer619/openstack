...
class test_verify_communication_of_mtu9000_instance_on_different_compute_and_different_tenant_network(BaseTestCase):
    """A Basic Test Case to test_verify_communication_of_mtu9000_instance_on_different_compute_and_different_tenant_network"""

    name = "Demo test_verify_communication_of_mtu9000_instance_on_different_compute_and_different_tenant_network"""
    ...
    def run_test(self, testbed_obj):
        ...
        if ping_response1 == 0 and ping_response2 == 0:
            command = "ping -c 3 -M do -s 8972  {}".format(
