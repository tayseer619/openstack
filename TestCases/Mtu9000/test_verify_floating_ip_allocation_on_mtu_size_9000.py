...
class test_verify_floating_ip_allocation_on_mtu_size_9000(BaseTestCase):
    """A Test case for test_verify_floating_ip_allocation_on_mtu_size_9000"""

    name = "test_verify_floating_ip_allocation_on_mtu_size_9000"
    ...
    def pre_testcase(self, testbed_obj):
        ...
        self.instance = common_utils.create_instance(
            testbed_obj, self.flavor_id, settings["server_1_name"], settings["network1_name"], common_utils.ids.get("network1_id"), None)
    ...
    def run_test(self, testbed_obj):
        ...
        assert self.instance.get("floating_ip") is not None
