...
class test_verify_create_snapshot_from_Dvr_instance(BaseTestCase):
    """A Test case for create_snapshot_from_Dvr_instance"""

    name = "create_snapshot_from_Dvr_instance"
