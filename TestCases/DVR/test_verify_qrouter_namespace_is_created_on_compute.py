...
class test_verify_qrouter_namespace_is_created_on_compute(BaseTestCase):
    """A Basic Test Case for test_verify_qrouter_namespace_is_created_on_compute"""

    name = "test_verify_qrouter_namespace_is_created_on_compute"
