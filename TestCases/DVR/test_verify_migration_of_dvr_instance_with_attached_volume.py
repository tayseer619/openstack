...
class test_verify_migration_of_dvr_instance_with_attached_volume(BaseTestCase):
    """A test case for migration_of_dvr_instance_with_attached_volume."""
    name = "migration_of_dvr_instance_with_attached_volume"
    ...
    def post_testcase(self, testbed_obj):
        ...
        common_utils.delete_volume(testbed_obj, common_utils.ids.get("project_id"), self.volume_id)