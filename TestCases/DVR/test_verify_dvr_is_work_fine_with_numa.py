...
class test_verify_dvr_is_work_fine_with_numa(BaseTestCase):
    """A Basic Test Case for test_verify_dvr_is_work_fine_with_numa"""

    name = "test_verify_dvr_is_work_fine_with_numa"
