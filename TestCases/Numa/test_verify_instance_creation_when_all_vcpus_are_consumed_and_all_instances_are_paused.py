...
class NumaInstanceAllVcpusConsumedAndPaused(BaseTestCase):
    """A Test case to verify all vcpus are consumed and paused"""
    name = "verify all vcpus are consumed and paused"
