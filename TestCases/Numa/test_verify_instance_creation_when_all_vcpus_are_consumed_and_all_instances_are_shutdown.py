...
class NumaInstanceAllVcpusConsumedAndShutdown(BaseTestCase):
    """A Test case to verify all vcpus are consumed and shutdown"""
    name = "all vcpus are consumed and shutdown"
    ...
    def run_test(self, testbed_obj):
        ...
        # performing Shutdown on the server
