...
class test_verify_migration_of_numa_instance_with_attached_volume(BaseTestCase):
    """A test case for migration_of_numa_instance_with_attached_volume."""
    name = "migration_of_numa_instance_with_attached_volume"
    ...
    def pre_testcase(self, testbed_obj):
        ...
        self.compute2 = common_utils.get_compute_name(testbed_obj, "compute-2")
    ...
    def run_test(self, testbed_obj):
        ...
        response = Nova.live_migrate_server(
            overcloud_ep, overcloud_token, self.instance.get("id"), self.compute2)
        assert response == 202
        # new host
