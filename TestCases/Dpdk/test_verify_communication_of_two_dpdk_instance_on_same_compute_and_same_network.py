...
class test_verify_communication_of_two_dpdk_instance_on_same_compute_and_same_network(BaseTestCase):
    """A Basic Test Case test_verify_communication_of_two_dpdk_instance_on_same_compute_and_same_network """

    name = "test_verify_communication_of_two_dpdk_instance_on_same_compute_and_same_network"""
