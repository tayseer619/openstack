...
class test_verify_deletion_of_barbican_secret(BaseTestCase):
    """test_verify_deletion_of_barbican_secret"""

    name = "test_verify_deletion_of_barbican_secret"
    ...
    def run_test(self, testbed_obj):
        ...
        # searching secret
        delete_secret(testbed_obj, self.secret_id)
        assert secret_id != "" or None
