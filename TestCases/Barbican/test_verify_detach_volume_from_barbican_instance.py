...
class test_verify_detach_volume_from_barbican_instance(BaseTestCase):
    """A test case for test_verify_detach_volume_from_barbican_instance"""

    name = "test_verify_detach_volume_from_barbican_instance"
