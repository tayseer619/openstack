...
from automatos_framework.product_api.rest.openstack.nova import Nova
...
class test_verify_migration_of_barbican_instance_with_attached_volume(BaseTestCase):
    """A test case for migration_of_barbican_instance_with_attached_volume."""

    name = "migration_of_barbican_instance_with_attached_volume"
    ...
    def pre_testcase(self, testbed_obj):
        ...
        self.volume_id = common_utils.search_and_create_volume(
            testbed_obj, common_utils.ids.get("project_id"), settings.get("volume1_name"), settings.get("volume_size"))
