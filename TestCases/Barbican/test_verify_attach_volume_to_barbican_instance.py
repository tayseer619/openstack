...
class test_verify_attach_volume_to_barbican_instance(BaseTestCase):
    """A test case for attaching the volume to Barbican instance"""

    name = "test_verify_attach_volume_to_barbican_instance"
