...
class test_verify_create_snapshot_from_barbican_instance(BaseTestCase):
    """A Test case for create_snapshot_from_barbican_instance"""

    name = "create_snapshot_from_barbican_instance"
