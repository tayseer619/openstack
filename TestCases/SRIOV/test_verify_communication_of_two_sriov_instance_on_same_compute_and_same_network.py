...
class test_verify_communication_of_two_sriov_instance_on_same_compute_and_same_network(BaseTestCase):
    """A Basic Test Case for communication_of_two_sriov_instance_on_same_compute_and_same_network"""

    name = "communication_of_two_sriov_instance_on_same_compute_and_same_network"
