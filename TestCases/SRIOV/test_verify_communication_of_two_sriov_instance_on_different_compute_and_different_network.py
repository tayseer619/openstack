...
class test_verify_communication_of_two_sriov_instance_on_different_compute_and_different_network(BaseTestCase):
    """A Basic Test Case for communication_of_two_sriov_instance_on_different_compute_and_different_network"""

    name = "communication_of_two_sriov_instance_on_different_compute_and_different_network"
    ...
    def pre_testcase(self, testbed_obj):
        ...
        self.instance2 = common_utils.create_instance(
            ...
            common_utils.ids.get("network2_id"), self.compute1, "No", "sriov", common_utils.ids.get("subnet2_id"))
