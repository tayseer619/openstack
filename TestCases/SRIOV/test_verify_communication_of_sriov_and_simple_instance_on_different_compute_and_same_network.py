...
class TestVerifyCommunicationOfTwoSriovInstanceOnSameComputeAndSameNetwork(BaseTestCase):
    """A Basic Test Case for VerifyCommunicationOfTwoSriovInstanceOnSameComputeAndSameNetwork"""

    name = "Verify Communication Of Two Sriov Instance On Same Compute And Same Network"
