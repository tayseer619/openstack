...
class test_verify_create_snapshot_from_sriov_instance(BaseTestCase):
    """A Test case for create_snapshot_from_sriov_instance"""

    name = "create_snapshot_from_sriov_instance"
    ...
    def pre_testcase(self, testbed_obj):
        ...
        # Creating the numa flavor and instance
