...
class test_verify_communication_of_two_sriov_instance_on_different_compute_and_same_network(BaseTestCase):
    """A Basic Test Case for communication_of_two_sriov_instance_on_different_compute_and_same_network"""

    name = "communication_of_two_sriov_instance_on_different_compute_and_same_network"
    ...
    def pre_testcase(self, testbed_obj):
        ...
        self.instance2 = common_utils.create_instance(
            ...
            common_utils.ids.get("network1_id"), self.compute1, "No", "sriov", common_utils.ids.get("subnet1_id"))
    ...
    def run_test(self, testbed_obj):
        ...
        logging.debug(
            "Wait for traffic to appear on reprsenter port as instances are already pinged during creation")
        time.sleep(60)
        # ping test instance
