...
class test_verify_detach_volume_from_sriov_instance_instance(BaseTestCase):
    """A test case for detaching the volume from sriov instance"""
    name = "test_verify_detach_volume_from_sriov_instance_instance"
