...
class test_verify_create_Hugepage_instance_from_snapshot(BaseTestCase):
    """A Test case for create_Hugepage_instance_from_snapshot"""

    name = "create_Hugepage_instance_from_snapshot"
