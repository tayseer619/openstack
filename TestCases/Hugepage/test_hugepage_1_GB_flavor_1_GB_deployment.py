...
class test_verify_instance_creation_with_hugepage_1GB_flavor_and_1GB_deployment(BaseTestCase):
    """Test case to check the compatibility of 1GB hugepage flavor with 1GB Hugepage deployment."""
    name = "Hugepage 1GB flavor with 1GB deployment"
    ...
    def run_test(self, testbed_obj):
        ...
        # checking if hugepage size in ini_file is same as in the instance.
