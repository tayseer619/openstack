...
class hugepageInstanceAllHugepageConsumedAndSuspend(BaseTestCase):
    """A Test case to verify all hugepages are consumed and suspended"""
    name = "verify all hugepages are consumed and suspended"
