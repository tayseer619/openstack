...
class hugepageInstanceAllHugepagesConsumedAndShutdown(BaseTestCase):
    """A Test case to verify all hugepages are consumed and shutdown"""
    name = "hugepage Instance All Hugepages Consumed And Shutdown"
    ...
    def run_test(self, testbed_obj):
        ...
        # performing Pause on the server
        ...
        common_utils.perform_action_on_server(
            overcloud_ep, overcloud_token, self.instances, "os-stop")
