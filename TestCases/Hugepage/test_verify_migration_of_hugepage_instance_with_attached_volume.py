...
class test_verify_migration_of_hugepage_instance_with_attached_volume(BaseTestCase):
    """A test case for migration_of_hugepage_instance_with_attached_volume."""
    name = "migration_of_hugepage_instance_with_attached_volume"
