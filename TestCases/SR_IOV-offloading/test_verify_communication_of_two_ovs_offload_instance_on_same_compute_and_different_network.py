...
class test_verify_communication_of_two_ovs_offload_instance_on_same_compute_and_different_network(BaseTestCase):
    """A Basic Test Case for test_verify_communication_of_two_ovs_offload_instance_on_same_compute_and_different_network"""

    name = "test_verify_communication_of_two_ovs_offload_instance_on_same_compute_and_different_network"
    ...
    def pre_testcase(self, testbed_obj):
        ...
        self.instance2 = common_utils.create_instance(
            ...
            common_utils.ids.get("network2_id"), self.compute0, "No", "smart_nic", common_utils.ids.get("subnet2_id"))
