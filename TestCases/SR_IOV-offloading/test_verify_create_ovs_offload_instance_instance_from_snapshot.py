...
class test_verify_create_ovs_offload_instance_instance_from_snapshot(BaseTestCase):
    """A Test case for create_offloading_instance_from_snapshot"""

    name = "create_offloading_instance_from_snapshot"
