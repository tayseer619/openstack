...
class test_verify_migration_of_offloading_instance_with_attached_volume(BaseTestCase):
    """A test case for migration_of_offloading_instance_with_attached_volume."""
    name = "migration_of_offloading_instance_with_attached_volume"
