...
class test_verify_create_snapshot_from_offloading_instance(BaseTestCase):
    """A Test case for create_snapshot_from_offloading_instance"""

    name = "create_snapshot_from_offloading_instance"
